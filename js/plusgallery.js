...
(function ($){
    $.fn.plusGallery = function(options){
        ...
        var pg = {
            ...
            limit: 300, //Limit of photos to load for gallery / more that 60 is dumb, separate them into different albums
            ...
            init: function(){
                ...
                _doc.on('click','.pgthumb',function(e){
                    ...
                    //todo
                    //$('.pgthumb')  gives the li tag and get the child a href tag here

                    //check for the dimensions
                    //if it is in that range and a panaroma open a new php page and render it there

                    // $('#dialog').after('<img id = "temphyper" src="' + pg.imgArray[idx] + '" data-src="' + pg.imgArray[idx] + '" title="' + pg.titleArray[idx] + '" alt="' + pg.titleArray[idx] + '" id="pgzoomimg' + idx + '" class="dialogify" hidden>');
                    $('#tempImg').attr("src",pg.imgArray[idx]);

                    $('#dialog').attr("sourceUrl",pg.imgArray[idx]);
            ...
            writeHTML: function(){
                ...
                if(pg.albumTitle === true) {
                    $('#pgthumbview').prepend('<ul id="pgthumbcrumbs" class="clearfix"><li id="pgthumbhome"><img src="../images/plusgallery/images.jpg"></li></ul>');
                }
            },
            ...
            parseData: function(json,title){
                ...
                $('#pgthumbcrumbs').append('<li class="pgalbumtitle">' + title + '</li>');
